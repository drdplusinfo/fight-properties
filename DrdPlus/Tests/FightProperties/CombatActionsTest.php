...
class CombatActionsTest extends TestWithMockery
{
    ...
    /**
     * @test
     * @expectedException \DrdPlus\FightProperties\Exceptions\UnknownCombatActionCode
    ...
    /**
     * @test
     * @expectedException \DrdPlus\FightProperties\Exceptions\IncompatibleCombatActions
     */
    ...
    /**
     * @test
     * @expectedException \DrdPlus\FightProperties\Exceptions\InvalidFormatOfRoundsOfAiming
